...
public class ObjectifyDao<T> extends DAOBase {
    ...
    public T getByProperty(String propName, Object propValue)
        ...
        T obj = fetch.next();
        if (fetch.hasNext()) {
//            throw new PreparedQuery.TooManyResultsException(q.toString() + " returned too many results");
        }
        return obj;
    }
    ...
    public T getByExample(T exampleObj) throws PreparedQuery.TooManyResultsException {
        ...
        T obj = fetch.next();
        if (fetch.hasNext()) {
//            throw new PreparedQuery.TooManyResultsException(q.toString()
